          ...
          >
            <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-neon-cyan/10">
              <svg viewBox="0 0 35 33" className="h-6 w-6" fill="none">
                ...
                <path d="M33.52 11.35l1.1-5.36L32.96 1l-12.7 9.4 4.89 4.11 6.89 2.01 1.52-1.77-.66-.48 1.05-.96-.81-.62 1.05-.8-.69-.52zM1l1.11 5.35-.71.52 1.06.8-.81.62 1.05.96-.66.48 1.52 1.77 6.89-2.01 4.89-4.11L2.66 1 1 11.35z" fill="#763D16" stroke="#763D16" strokeLinecap="round" strokeLinejoin="round" />
